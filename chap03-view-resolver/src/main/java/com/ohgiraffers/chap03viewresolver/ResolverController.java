...
@Controller
@RequestMapping("/*")
// 와일드카드 - 파일을 지정할 때, 구체적인 이름 대신에 여러 파일을
// 동시에 지정할 목적으로 사용하는 특수 기호. `＊', `？' 따위.
    ...
    * */
    ...
    public String stringRedirectFlashAttribute (RedirectAttributes rttr){
        ...
        * */
        ...
        rttr.addFlashAttribute("falshMessage1", "리다이렉트 attr 사용하여 redirect..");
        return "redirect:/";
    }
...
* POST요청을 보내는 경우 forward를 사용한다면 응답페이지에서 새로고침을 한다면 문제가 될 수 있다.
* */
