package com.ohgiraffers.chap07thymeleaf.controllor;
...
public class LectureController {
    ...
    public ModelAndView etc(ModelAndView mv){
        ...
        memberList.add(new MemberDTO("홍길동", 10000, '남', "서울시 서초구"));
        memberList.add(new MemberDTO("유관순", 10090000, '여', "서울시 노원구"));
        ...
        memberMap.put("m02", new MemberDTO("유관순", 20, '여', "서울시 노원구"));
        memberMap.put("m03", new MemberDTO("장보고", 40, '남', "서울시 서초구"));
